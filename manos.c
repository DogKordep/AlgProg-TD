...
void CarregaMapa(const char *arquivoMapa)
{
    ...
    for (int i = 0; i < ALTURA_MAPA; i++)
    {
        for (int j = 0; j < LARGURA_MAPA; j++)
        {
            ...
            if (caractere == 'W' || caractere == ' ' || caractere == 'J' || caractere == 'M' || caractere == 'H' || caractere == 'R' || caractere == 'S' || caractere == 'C')
            {
                mapa[i][j] = caractere;
            }
            else if (caractere == '\n')
...
void DesenhaMapa()
{
    for (int i = 0; i < ALTURA_MAPA; i++)
    {
        for (int j = 0; j < LARGURA_MAPA; j++)
        {
            ...
            if (mapa[i][j] == 'S' || (mapa[i-1][j] == 'S' && mapa[i][j-1] == 'S' && mapa[i-1][j-1] == 'S' && mapa[i+1][j] == 'S' && mapa[i][j+1] == 'S' && mapa[i+1][j+1] == 'S'))
            {
            ...
            if (mapa[i][j] == 'R')
            {
                ...
                DrawRectangleLines(j * LARGURA_BLOCO, i * ALTURA_BLOCO, LARGURA_BLOCO, ALTURA_BLOCO, BLACK);
            }
            if (mapa[i][j] == 'H')
            {
             ...
             {
                DrawRectangle(j * LARGURA_BLOCO, i * ALTURA_BLOCO, LARGURA_BLOCO, ALTURA_BLOCO, BEIGE);
             }
            if (mapa[i][j] == 'D')
            {
...
{
    if ((IsKeyDown(KEY_UP) || IsKeyDown(KEY_W)) && Jogador->y > 0 && mapa[(int)(Jogador->y - 1)/ALTURA_BLOCO][(int)Jogador->x/LARGURA_BLOCO] != 'W' &&
            mapa[(int)(Jogador->y - 1)/ALTURA_BLOCO][(int)(Jogador->x + LARGURA_BLOCO - 1)/LARGURA_BLOCO] != 'W')
    {
        Jogador->dy = -1;
    }
    if ((IsKeyDown(KEY_LEFT) || IsKeyDown(KEY_A)) && Jogador->x > 0 && mapa[(int)Jogador->y/ALTURA_BLOCO][(int)(Jogador->x - 1)/LARGURA_BLOCO] != 'W' &&
    ...
    if ((IsKeyDown(KEY_DOWN) || IsKeyDown(KEY_S)) && Jogador->y < ((ALTURA_MAPA*ALTURA_BLOCO)-ALTURA_BLOCO) &&
    ...
    if ((IsKeyDown(KEY_RIGHT) || IsKeyDown(KEY_D)) && Jogador->x < ((LARGURA_MAPA*LARGURA_BLOCO)-LARGURA_BLOCO) && mapa[(int)Jogador->y/ALTURA_BLOCO][(int)(Jogador->x + LARGURA_BLOCO)/LARGURA_BLOCO] != 'W' && mapa[(int)(Jogador->y + ALTURA_BLOCO - 1)/ALTURA_BLOCO][(int)(Jogador->x + LARGURA_BLOCO)/LARGURA_BLOCO] != 'W')
    {
        Jogador->dx = 1;
    }
...
int VidaJogador(JOGADOR *Jogador, INIMIGO *Inimigo, int TAM)
{
    for(int i=0; i<TAM; i++)
    {
...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        case TITULO:
        {
            ...
            if((botaopress(botaoNOVOJ) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_N))
            {
                currentScreen = FASES;
            }
            ...
            if((botaopress(botaoCARREGAR) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_C))
            {
                //Carregar jogo salvo
                currentScreen = JOGO;
            }
            ...
            if((botaopress(botaoSAIR) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_Q))
            {
                CloseWindow();
            }
        ...
        case JOGO:
        {
            ...
            if(VidaJogador(&Jogador, Inimigo, 5) == 1)
            {
                CloseWindow();
            }
        }
        ...
        case PAUSE:
        {
            ...
            if((botaopress(botaoCONT) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_C))
            {
                currentScreen = JOGO;
            }
            ...
            if((botaopress(botaoCARREGAR2) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_L))
            {
                //carregar jogo salvo
                currentScreen = JOGO;
            }
            ...
            if((botaopress(botaoSALVAR) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_S))
            {
            ...
            if((botaopress(botaoVOLTAR) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_V))
            {
                currentScreen = TITULO;
            }
            ...
            if((botaopress(botaoSAIR2) && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) || IsKeyPressed(KEY_F))
            {
                CloseWindow();
            }
        ...
        case PAUSE:
        {
          ...
          //  DrawText("PRESS ENTER or TAP to JUMP to GAMEPLAY SCREEN", 120, 220, 20, DARKGREEN);
            ...
            DrawText("PRESSIONE [ TAB ] PARA CONTINUAR", 30, 550, 20, WHITE);
            DrawText("[ C ]   CONTINUAR\n\n\n[ L ]   CARREGAR\n\n\n[ S ]   SALVAR\n\n\n[ V ]   VOLTAR\n\n\n[ F ]   SAIR SEM SALVAR", 880, 368, 20, WHITE);
        }
        break;
        default:
            break;
